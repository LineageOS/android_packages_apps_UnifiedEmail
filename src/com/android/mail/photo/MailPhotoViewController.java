...
public class MailPhotoViewController extends PhotoViewController {
    ...
    public MailPhotoViewController(MailPhotoViewActivity activity) {
        super(activity);
        mActivity = activity;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mActionHandler = new AttachmentActionHandler(mActivity, null);
        mActionHandler.initialize(mActivity.getFragmentManager());
    }
    ...
    public void updateActionBar() {
        ...
        final String size = AttachmentUtils.convertToHumanReadableSize(mActivity, attachment.size);
        ...
        if (attachment.isSavedToExternal()) {
            actionBar.setSubtitle(mActivity.getResources().getString(R.string.saved, size));
