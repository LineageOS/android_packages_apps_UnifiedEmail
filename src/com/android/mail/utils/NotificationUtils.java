        ...
        try {
            ...
            if (unreadCount > 0) {
                ...
                if (cursor.moveToNext()) {
                    ...
                    when = configureLatestEventInfoFromConversation(context,
                            account, folderPreferences, notification, wearableExtender,
                            msgNotifications, notificationId, cursor, clickIntent,
                            notificationIntent, unreadCount, unseenCount, folder, contactFetcher);
